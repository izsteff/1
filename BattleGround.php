...
class BattleGround extends PluginBase implements Listener{
    ...
    public function onEnable(){
        ...
        $this->getLogger()->info(TextFormat::GREEN."BattleGround is On!");
    }
    
    public function onDisable(){
        $this->getLogger()->info(TextFormat::RED."BattleGround disabled");
    }
                    ...
                    if(isset($args[0])){
                        ...
                        switch(strtolower($args[0])){
                            ...
                            case "help":
                                ...
                                $msg = "§9--- §c§lBattle Ground help§l§9 ---§r§f";
                            ...
                            case "delete":
                                ...
                                break;
                            case "join":
                                if(!$sender->hasPermission('bg.command.join')){
                                    $sender->sendMessage($this->getMsg('has_not_permission'));
                                    break;
                                }
                                if(!isset($args[1]) || isset($args[2])){
								...
								if($sender->getPlayer()->getLevel()->getFolderName() != "MainSpawn"){
									$sender->sendMessage("Please use this in Lobby");
                                    break;
								}
                                ...
                                break;
                            case "leave":
                                if(!$sender->hasPermission('bg.command.leave')){
                                    $sender->sendMessage($this->getMsg ('has_not_permission'));
                                    break;
                                }
                                if(isset($args[1])){
                                ...
                                break;
                            case "start":
                                if(!$sender->hasPermission('bg.command.start')){
                                ...
                                break;
                            case "stop":
                                if(!$sender->hasPermission('bg.command.stop')){
                                    $sender->sendMessage($this->plugin->getMsg('has_not_permission'));
                                    break;
                                }
                                if(isset($args[2])){
                                ...
                                break;
                            //TO-DO case "ban":
                            case "kick": // sb kick [arena] [player] [reason]
                                if(!$sender->hasPermission('bg.command.kick')){
                                    $sender->sendMessage($this->getMsg('has_not_permission'));
                                    break;
                                }
                                ...
                                break;
                            case "setlobby":
                                if(!$sender->hasPermission('bg.command.setlobby')){
                                    $sender->sendMessage($this->getMsg('has_not_permission'));
                                    break;
                                }
                                if(isset($args[1])){
                ...
                if($args[0] === 'help'){
                    ...
                    if(isset($args[1])){
                        if(intval($args[1]) >= 1 && intval($args[1]) <= 3){
                            $help = "§9--- §6§lSmash Hero setup help§l $args[1]/3§9 ---§r§f";
                    ...
                    $p->sendMessage("§9--- §6§lSmash Hero setup help§l 1/3§9 ---§r§f".$help1);
                    return;
                }
            }
    ...
    public function getPlayerArena(Player $p){
        foreach($this->ins as $arena){
            $players = array_merge($arena->ingamep, $arena->lobbyp, $arena->spec, $arena->zombie);
